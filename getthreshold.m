function [threshold] = getthreshold(X,PF,DECISION_ENTRY,time_search_type)
%GETTHRESHOLD provides the decision threshold (lambda) based on the
%decision database provided and the probability of false alarm.
...
%
%OUTPUTS:
%   threshold   A single dimensional threshold value in units of W.
%
%
%
%%
