...
## Final product: $(ROOT_DIR)/uavrt_detection
...
%.o : $(ROOT_DIR)/codegen/exe/uavrt_detection/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(ROOT_DIR)/codegen/exe/uavrt_detection/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(ROOT_DIR)/codegen/exe/uavrt_detection/examples/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(ROOT_DIR)/codegen/exe/uavrt_detection/examples/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
