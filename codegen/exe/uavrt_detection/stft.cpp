                        ...
                        ::coder::array<float, 2U> &T)
{
  ...
  if (!(nCol >= 0.0)) {
    rtNonNegativeError(nCol, &g_emlrtDCI);
  }
  ...
  for (acoef = 0; acoef < i; acoef++) {
    ...
    if (nCol + 1.0 > d) {
      ...
      if ((static_cast<int>(d) < 1) || (static_cast<int>(d) > x.size(0))) {
        rtDynamicBoundsError(static_cast<int>(d), 1, x.size(0), &i_emlrtBCI);
      }
      b_i1 = static_cast<int>(d);
    }
    if ((acoef + 1 < 1) || (acoef + 1 > xin.size(1))) {
      rtDynamicBoundsError(acoef + 1, 1, xin.size(1), &j_emlrtBCI);
    }
    bcoef = b_i1 - i1;
  ...
  case 0: {
    ...
    if (signalwavelet::internal::iseven(static_cast<double>(f.size(0)))) {
      ...
      if ((static_cast<int>(nCol) < 1) ||
        ...
        rtDynamicBoundsError(static_cast<int>(nCol), 1, f.size(0), &p_emlrtBCI);
      }
  ...
  default:
    if (S.size(0) != opts_NumFreqSamples) {
      if (opts_NumFreqSamples < 1.0) {
        ...
        if (S.size(0) < 1) {
          rtDynamicBoundsError(1, 1, S.size(0), &k_emlrtBCI);
        }
    ...
    if (f.size(0) != opts_NumFreqSamples) {
      if (opts_NumFreqSamples < 1.0) {
        ...
        if (f.size(0) < 1) {
          rtDynamicBoundsError(1, 1, f.size(0), &m_emlrtBCI);
        }
        if (opts_NumFreqSamples !=
            static_cast<int>(std::floor(opts_NumFreqSamples))) {
          rtIntegerError(opts_NumFreqSamples, &e_emlrtDCI);
        }
        if ((static_cast<int>(opts_NumFreqSamples) < 1) ||
  ...
  if (S.size(0) < 1) {
    ...
    if (S.size(0) > f.size(0)) {
      rtDynamicBoundsError(S.size(0), 1, f.size(0), &f_emlrtBCI);
    }
    bcoef = S.size(0);
  }
  iv[0] = 1;
  ...
  if (S.size(1) < 1) {
    ...
    if (y.size(1) < 1) {
      rtDynamicBoundsError(1, 1, y.size(1), &e_emlrtBCI);
    }
    if (S.size(1) > y.size(1)) {
      rtDynamicBoundsError(S.size(1), 1, y.size(1), &d_emlrtBCI);
    }
    bcoef = S.size(1);
  }
  T.set_size(1, bcoef);
                        ...
                        ::coder::array<double, 2U> &T)
{
  ...
  for (iCol = 0; iCol < i; iCol++) {
    ...
    if ((iCol + 1 < 1) || (iCol + 1 > xin.size(1))) {
      rtDynamicBoundsError(iCol + 1, 1, xin.size(1), &j_emlrtBCI);
    }
    b_bcoef = xin.size(0);
    b_xin[0] = xin.size(0);
    b_xin[1] = 1;
  ...
  if (!(opts_FFTLength >= 0.0)) {
    rtNonNegativeError(opts_FFTLength, &l_emlrtDCI);
  }
  i = static_cast<int>(std::floor(opts_FFTLength));
  if (opts_FFTLength != i) {
    rtIntegerError(opts_FFTLength, &m_emlrtDCI);
  }
  loop_ub = static_cast<int>(opts_FFTLength);
  xin.set_size(loop_ub, b_c.size(1), b_c.size(2));
  if (loop_ub != i) {
    rtIntegerError(opts_FFTLength, &k_emlrtDCI);
  }
  ...
  if (b_c.size(0) > loop_ub) {
    ...
    for (iCol = 0; iCol < i; iCol++) {
      ...
      for (int k{0}; k < c_bcoef; k++) {
        ...
        if ((k + 1 < 1) || (k + 1 > i1)) {
          rtDynamicBoundsError(k + 1, 1, i1, &u_emlrtBCI);
        }
        i1 = (b_bcoef + k) + 1;
      ...
      for (int k{i1}; k <= loop_ub; k++) {
        i2 = wrappedData.size(0) * wrappedData.size(1);
        if ((k < 1) || (k > i2)) {
          rtDynamicBoundsError(k, 1, i2, &t_emlrtBCI);
        }
      ...
      for (c_bcoef = 0; c_bcoef < csz_idx_0; c_bcoef++) {
        ...
        for (int k{0}; k < loop_ub; k++) {
          i1 = wrappedData.size(0) * wrappedData.size(1);
          if (k + 1 > i1) {
            rtDynamicBoundsError(k + 1, 1, i1, &q_emlrtBCI);
          }
          i1 = wrappedData.size(0) * wrappedData.size(1);
          if (k + 1 > i1) {
            rtDynamicBoundsError(k + 1, 1, i1, &s_emlrtBCI);
          }
          i1 = (b_bcoef + k) + 1;
          if ((i1 < 1) || (i1 > b_c.size(0))) {
      ...
      if ((iCol + 1 < 1) || (iCol + 1 > i1)) {
        rtDynamicBoundsError(iCol + 1, 1, i1, &w_emlrtBCI);
      }
      b_bcoef = wrappedData.size(0) * wrappedData.size(1);
      rtSubAssignSizeCheck(xin.size(), 1, &b_bcoef, 1, &d_emlrtECI);
      b_bcoef = wrappedData.size(0) * wrappedData.size(1);
      c[0] = xin.size(0);
