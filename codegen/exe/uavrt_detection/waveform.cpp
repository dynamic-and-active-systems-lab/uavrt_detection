...
static void b_binary_expand_op(coder::array<bool, 2U> &in1, const coder::array<
  double, 2U> &in2, const int in3[2], const coder::array<double, 2U> &in4, const
  int in5[2]);
...
static void d_binary_expand_op(coder::array<bool, 2U> &in1, const coder::array<
  double, 2U> &in2, const int in3[2], const coder::array<double, 2U> &in4);
static void e_binary_expand_op(coder::array<bool, 2U> &in1, const coder::array<
  double, 2U> &in2, const int in3[2], const coder::array<double, 2U> &in4);
...
static void k_binary_expand_op(coder::array<bool, 1U> &in1, const coder::array<
  bool, 1U> &in2, const coder::array<bool, 1U> &in3);
...
static void minus(coder::array<double, 2U> &in1, const coder::array<double, 2U>
                  &in2);
static void n_binary_expand_op(coder::array<bool, 1U> &in1, const coder::array<
  ...
  &excluded_freq_bands)
{
  ...
  switch (b_n) {
   case 0:
    {
      coder::array<bool, 1U> b_minstartlog;
...
void waveform::setweightingmatrix()
{
  ...
  coder::array<bool, 2U> b_output_samps;
