...
void b_validateattributes(double a, double attributesMixed_f9)
{
  ...
  if (!(a >= attributesMixed_f9)) {
    rtErrorWithMessageID("FFTLength", ">=", "NaN", kb_emlrtRTEI.fName,
                         kb_emlrtRTEI.lineNo);
  }
}
...
void validateattributes(const ::coder::array<double, 1U> &a)
{
  ...
  boolean_T p;
  if (a.size(0) == 0) {
    i_rtErrorWithMessageID("Window", eb_emlrtRTEI.fName, eb_emlrtRTEI.lineNo);
  }
  p = true;
  k = 0;
  exitg1 = false;
  ...
  if (!p) {
    g_rtErrorWithMessageID("Window", cb_emlrtRTEI.fName, cb_emlrtRTEI.lineNo);
  }
  p = true;
  k = 0;
  exitg1 = false;
  ...
  if (!p) {
    h_rtErrorWithMessageID("Window", db_emlrtRTEI.fName, db_emlrtRTEI.lineNo);
  }
}
...
void validateattributes(double a)
{
  ...
  if (!(a > 1.0)) {
    rtErrorWithMessageID("WindowLength", ">", "1", kb_emlrtRTEI.fName,
                         kb_emlrtRTEI.lineNo);
  }
}
...
void validateattributes(double a, double attributesMixed_f11)
{
  ...
  if (!(a < attributesMixed_f11)) {
    rtErrorWithMessageID("OverlapLength", "<", "NaN", kb_emlrtRTEI.fName,
                         kb_emlrtRTEI.lineNo);
  }
}
