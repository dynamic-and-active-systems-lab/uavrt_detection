...
void b_validateattributes(double a, double attributesMixed_f9)
{
  ...
  if (std::isinf(a) || std::isnan(a) || (!(std::floor(a) == a))) {
    f_rtErrorWithMessageID("FFTLength", y_emlrtRTEI.fName, y_emlrtRTEI.lineNo);
  }
  if (a < 0.0) {
    g_rtErrorWithMessageID("FFTLength", ab_emlrtRTEI.fName,
                           ab_emlrtRTEI.lineNo);
  }
  if (!(a >= attributesMixed_f9)) {
    rtErrorWithMessageID("FFTLength", ">=", "NaN", pc_emlrtRTEI.fName,
                         pc_emlrtRTEI.lineNo);
  }
}
...
void validateattributes(const ::coder::array<double, 1U> &a)
{
  ...
  boolean_T p;
  if (a.size(0) == 0) {
    e_rtErrorWithMessageID("Window", x_emlrtRTEI.fName, x_emlrtRTEI.lineNo);
  }
  p = true;
  k = 0;
  exitg1 = false;
  ...
  if (!p) {
    c_rtErrorWithMessageID("Window", v_emlrtRTEI.fName, v_emlrtRTEI.lineNo);
  }
  p = true;
  k = 0;
  exitg1 = false;
  ...
  if (!p) {
    d_rtErrorWithMessageID("Window", w_emlrtRTEI.fName, w_emlrtRTEI.lineNo);
  }
}
...
void validateattributes(double a)
{
  ...
  if (std::isinf(a) || std::isnan(a) || (!(std::floor(a) == a))) {
    f_rtErrorWithMessageID("WindowLength", y_emlrtRTEI.fName,
                           y_emlrtRTEI.lineNo);
  }
  if (a < 0.0) {
    g_rtErrorWithMessageID("WindowLength", ab_emlrtRTEI.fName,
                           ab_emlrtRTEI.lineNo);
  }
  if (!(a > 1.0)) {
    rtErrorWithMessageID("WindowLength", ">", "1", pc_emlrtRTEI.fName,
                         pc_emlrtRTEI.lineNo);
  }
}
...
void validateattributes(double a, double attributesMixed_f11)
{
  ...
  if (std::isinf(a) || std::isnan(a) || (!(std::floor(a) == a))) {
    f_rtErrorWithMessageID("OverlapLength", y_emlrtRTEI.fName,
                           y_emlrtRTEI.lineNo);
  }
  if (a < 0.0) {
    g_rtErrorWithMessageID("OverlapLength", ab_emlrtRTEI.fName,
                           ab_emlrtRTEI.lineNo);
  }
  if (!(a < attributesMixed_f11)) {
    rtErrorWithMessageID("OverlapLength", "<", "NaN", pc_emlrtRTEI.fName,
                         pc_emlrtRTEI.lineNo);
  }
}
