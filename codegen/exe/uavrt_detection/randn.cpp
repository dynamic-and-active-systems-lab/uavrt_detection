...
void randn(double varargin_1, int r_size[2])
{
  ...
  static rtDoubleCheckInfo
      e_emlrtDCI{
          ...
          "eml_randn", // fName
          "C:\\Program "
          "Files\\MATLAB\\toolbox\\eml\\lib\\matlab\\randfun\\private\\eml_"
          "randn.m", // pName
          4          // checkKind
      };
  if (method == 0U) {
    if (b_method == 4U) {
      ...
      r_size[0] = static_cast<int>(varargin_1);
      r_size[1] = 100;
    } else if (b_method == 5U) {
      if (!(varargin_1 >= 0.0)) {
        rtNonNegativeError(varargin_1, &c_emlrtDCI);
      }
      r_size[0] = static_cast<int>(varargin_1);
      r_size[1] = 100;
    } else {
      if (!(varargin_1 >= 0.0)) {
        rtNonNegativeError(varargin_1, &d_emlrtDCI);
      }
      r_size[0] = static_cast<int>(varargin_1);
      r_size[1] = 100;
    }
    ...
    if (!(varargin_1 >= 0.0)) {
      rtNonNegativeError(varargin_1, &e_emlrtDCI);
    }
    r_size[0] = static_cast<int>(varargin_1);
    r_size[1] = 100;
  }
