...
EXTERN_C LIBMWVOXELGRIDFILTER_API void voxelGridAlgImpl_single_uint8Color(
    const float* pData,
    const uint32_T numPoints,
...
EXTERN_C LIBMWVOXELGRIDFILTER_API void voxelGridAlgImpl_double_uint8Color(
    const double* pData,
    const uint32_T numPoints,
    const unsigned char* pColor,
...
EXTERN_C LIBMWVOXELGRIDFILTER_API void voxelGridAlgImpl_single_uint16Color(
    const float* pData,
    const uint32_T numPoints,
...
EXTERN_C LIBMWVOXELGRIDFILTER_API void voxelGridAlgImpl_double_uint16Color(
    const double* pData,
    const uint32_T numPoints,
    const uint16_T* pColor,
    const double* pNormal,
