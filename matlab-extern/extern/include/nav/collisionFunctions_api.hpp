...
/// @param[out] collCenters An Nx3 set of voxel-centers that are in collision with the geometry
/// @param[out] lengths An Nx1 set of lengths corresponding to voxels in collision
...
octomapCheckCollision(void* map,
                      const void* geom,
                      real64_T& distance,
                      ...
                      real64_T p1Vec[3],
                      real64_T p2Vec[3],
                      void* collCenters, // std::vector<std::array<double,3>
                      void* lengths,     // std::vector<double>
                      real64_T center[3],
                      real64_T pMin[3],
                      real64_T pMax[3]);
